  ...
  return (
    <UserLayout>
      <ToastContainer/>
        ...
        <h3 className='text-center text-m=lg font-bold uppercase text-stone-800 mb-4'>Interested users</h3>
                ...
                {interestedUsers.map(user => (
                    <tr key={user.id}>
                      ...
                      <td className="px-6 flex justify-end items-center py-4 whitespace-nowrap text-end text-sm font-medium">
                        <button type="button" disabled={user.make_deal} onClick={() => handleMakeDeal(user.listing, user.user.id)} className="mr-2 inline-flex items-center text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">
                          {user.confirm_deal ? (
                        ...
                        <Link href={`/intuserprofile/${user.user.id}`} className="mr-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">View Profile</Link>
